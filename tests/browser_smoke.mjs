...
try {
  ...
  // === CONTRACT_GLOBALS BEGIN (generated by scripts/extract_webui_contract.mjs; do not edit by hand) ===
  // F-01: per-name typeof preamble for the window-export contract.
  // app.js is a classic script (`const S` is not window.S) and workbench CSP
  // has no unsafe-eval, so names are unrolled as `typeof ident`.
  const CONTRACT_GLOBALS = Object.freeze([
  ...
  if (!CONTRACT_GLOBALS.length) throw new Error("CONTRACT_GLOBALS is empty");
  const kinds = await page.evaluate(() => ({
      ACTION_TIMELINE_OVERSCAN: typeof ACTION_TIMELINE_OVERSCAN,
      ACTION_TIMELINE_OVERVIEW_WIDTH: typeof ACTION_TIMELINE_OVERVIEW_WIDTH,
      ACTION_TIMELINE_PAGE_SIZE: typeof ACTION_TIMELINE_PAGE_SIZE,
      ACTION_TIMELINE_ROW_HEIGHT: typeof ACTION_TIMELINE_ROW_HEIGHT,
      S: typeof S,
      actionTimelineEntryKey: typeof actionTimelineEntryKey,
      actionTimelineOverviewVisualExtent: typeof actionTimelineOverviewVisualExtent,
      actionTimelineSelectionOverlaps: typeof actionTimelineSelectionOverlaps,
      actionTimelineSpan: typeof actionTimelineSpan,
      admissionSettled: typeof admissionSettled,
      annotationIsHeld: typeof annotationIsHeld,
      annotationStatus: typeof annotationStatus,
      buildExecutedCodeView: typeof buildExecutedCodeView,
      buildStepCard: typeof buildStepCard,
      commitActionTimelineOverviewSelection: typeof commitActionTimelineOverviewSelection,
      custTab: typeof custTab,
      execSourcesState: typeof execSourcesState,
      fetchAllMessages: typeof fetchAllMessages,
      fetchOlderMessages: typeof fetchOlderMessages,
      fetchRecentMessages: typeof fetchRecentMessages,
      forgetAdmission: typeof forgetAdmission,
      highlightTraceback: typeof highlightTraceback,
      loadAnnotations: typeof loadAnnotations,
      loadEarlierActionTimeline: typeof loadEarlierActionTimeline,
      mergeDelegationChildEvent: typeof mergeDelegationChildEvent,
      notebookExportLink: typeof notebookExportLink,
      ...
      rememberAdmission: typeof rememberAdmission,
      renderActionTimeline: typeof renderActionTimeline,
      renderAttachmentProblems: typeof renderAttachmentProblems,
      renderComposerRefChips: typeof renderComposerRefChips,
      renderDelegationPanel: typeof renderDelegationPanel,
      renderMd: typeof renderMd,
      renderMessageRefChips: typeof renderMessageRefChips,
      renderPins: typeof renderPins,
      renderRefProblems: typeof renderRefProblems,
      renderSheet: typeof renderSheet,
      sanitizeActionTimeline: typeof sanitizeActionTimeline,
      searchResultHttpUrl: typeof searchResultHttpUrl,
      selectExecFrame: typeof selectExecFrame,
      send: typeof send,
      setActiveTab: typeof setActiveTab,
      steerDelegationChild: typeof steerDelegationChild,
      t: typeof t,
      telemetryRow: typeof telemetryRow,
      timelineOverviewTimeToX: typeof timelineOverviewTimeToX,
      toggleActionTimelineTurn: typeof toggleActionTimelineTurn,
      updateActionTimelineLedger: typeof updateActionTimelineLedger,
  }));
  for (const name of CONTRACT_GLOBALS) {
    if (!Object.prototype.hasOwnProperty.call(kinds, name) || kinds[name] === "undefined") {
      throw new Error(`missing contract global: ${name}`);
    }
  }
  for (const name of Object.keys(kinds)) {
    if (!CONTRACT_GLOBALS.includes(name)) {
      throw new Error(`typeof map has extra name not in CONTRACT_GLOBALS: ${name}`);
    }
  }
  // === CONTRACT_GLOBALS END ===
