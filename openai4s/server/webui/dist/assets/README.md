...
| `index-DieDrsHI.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-QB2aWISU.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
