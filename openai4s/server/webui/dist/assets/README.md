...
| `index-BB_6MzkS.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-BdX2k03K.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
