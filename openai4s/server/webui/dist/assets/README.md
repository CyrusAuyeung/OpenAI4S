...
| `index-Bc_LbcoZ.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-uez_KuqE.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
